...
req = shared.SessionCreateInput(
    ...
    customer=shared.Customer(
        ...
        organization_entity_type=shared.CustomerOrganizationEntityTypeEnum.PUBLIC_INSTITUTION,
...
req = operations.UpdateCreditSessionRequest(
    session_input=shared.SessionInput(
        ...
        customer=shared.Customer(
            ...
            organization_entity_type=shared.CustomerOrganizationEntityTypeEnum.OTHER,
